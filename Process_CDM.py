...
class CDMSeries:
    ...
    def generate_chart(self):
        ...
        print("Chart Saved to <" + self.title + "_CDM_Chart.png> in " + out_directory)
        plt.savefig(out_directory + self.title + "_CDM_Chart.png", dpi=500, bbox_inches='tight', pad_inches=0.25)
        plt.clf()
...
def main(argv):
    parser = argparse.ArgumentParser(
        description='Read an input file and save the performance data as a csv and as a series of charts.')
